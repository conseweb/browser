...
//						WebChromeClient.onProgressChanged();
	...
	private void init(Context context, AttributeSet attrs) {
		...
		String pullLabel = context.getString(R.string.pull_to_refresh_pull_label);//下拉可以刷新
		String refreshingLabel = context.getString(R.string.pull_to_refresh_refreshing_label);//正在加载
		String releaseLabel = context.getString(R.string.pull_to_refresh_release_label);//松开可以刷新
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			//pullLabel = context.getString(R.string.pull_up_to_refresh_pull_label);//上拉可以刷新
			pullLabel = "上拉可刷新";
