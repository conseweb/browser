...
public class FloatWindowTurnthepageView extends LinearLayout {
	...
	public FloatWindowTurnthepageView(final Context context) {
		super(context);
		windowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
		LayoutInflater.from(context).inflate(R.layout.float_window_turethepage, this);
		View view = findViewById(R.id.turnpage_window_layout);
		...
		previouspage.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Launcher.TurnPrePage();
			}
		});
		
		nextpage.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Launcher.TurnNextPage();
			}
		});
	}
