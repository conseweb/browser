...
public class IOUtils {
	...
	public static final String APPLICATION_FOLDER = "Qing";
	...
	public static File getIconFolder() {
		...
		if (root != null) {
			...
			File folder = new File(root, ICON_FOLDER);
	...
	public static List<String> getSnapshotFileList() {
		List<String> result = new ArrayList<String>();
		File folder = getIconFolder();
		if (folder != null) {
			FileFilter filter = new FileFilter() {
				@Override
				public boolean accept(File pathname) {
