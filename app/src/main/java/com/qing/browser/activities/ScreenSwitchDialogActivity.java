			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				case R.id.hengping:
					editor.putInt(Constants.PREFERENCES_SCREEN_ORIENTATION,
								0);
					editor.commit();
					Toast.makeText(ScreenSwitchDialogActivity.this, "ºáÆÁ",
				...
				case R.id.shuping:
					editor.putInt(Constants.PREFERENCES_SCREEN_ORIENTATION,
								1);
					editor.commit(); 
					Toast.makeText(ScreenSwitchDialogActivity.this, "ÊúÆÁ",
							Toast.LENGTH_SHORT).show();
					finish();
					break;
				case R.id.xitong:
					editor.putInt(Constants.PREFERENCES_SCREEN_ORIENTATION,
							2);
					editor.commit(); 
					Toast.makeText(ScreenSwitchDialogActivity.this, "¸úËæÏµÍ³",
							Toast.LENGTH_SHORT).show();
					finish();
					break;
				}
